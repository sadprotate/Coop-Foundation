...
export const DEFAULT_GOD_OPTIONS = Object.freeze({ god_mode: false, attack_speed: 2, attack_damage: 10,
  ...
  total_rounds: 10, ready_check_seconds: 15, arena_start_countdown: 10, sword_objective_enabled: true, crystal_max_health: 100, crystal_damage_per_punch: 10, crystal_break_stages: 4, sword_accessibility_threshold: 0.25, sword_pickup_range: 2.2, sword_pickup_hold_time: 0, sword_damage: 30, sword_range: 3.4, sword_swing_arc: 1.2, sword_swing_speed: 1, sword_attack_recovery: 1.2, sword_knockback: 4, sword_blockable: true, sword_block_damage_reduction: 0.1, sword_movement_speed_multiplier: 1, sword_jump_critical_enabled: true, sword_critical_damage_multiplier: 2, camera_fov: 55, camera_distance: 11.5, camera_height: 11, camera_vertical_offset: 1, camera_min_pitch: 35, camera_max_pitch: 75, camera_rotation_speed: 1, camera_smoothing: 0.15, camera_follow_speed: 16, camera_zoom_min: 8, camera_zoom_max: 20 });
